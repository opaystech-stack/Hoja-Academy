      ...
      />
        ...
        <section className="py-16 max-md:py-10">
          <div className="max-w-5xl mx-auto px-6">
            <h2 className="text-color-001 text-3xl max-md:text-2xl font-bold mb-6">
              Pourquoi postuler
            </h2>
            <ul className="list-disc pl-6 flex flex-col gap-3 text-foreground text-lg max-md:text-base leading-7">
              <li>
        ...
        <section className="py-16 max-md:py-10">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <ol className="list-decimal pl-6 flex flex-col gap-4 text-foreground text-lg max-md:text-base leading-7">
              <li>
            ...
            <p className="mt-6 text-foreground/80 text-base leading-7">
        ...
        <section className="py-16 max-md:py-10 bg-background/60">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="text-color-001 text-3xl max-md:text-2xl font-bold mb-4">
              Formulaire de candidature
            </h2>
            <p className="mb-8 text-foreground/80 text-base leading-7">
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="flex flex-wrap gap-8 max-md:flex-col">
              <div className="flex-1 min-w-[260px]">
                <h3 className="text-color-001 text-xl font-bold mb-2 uppercase">
                  Prochaine cohorte
                </h3>
                <p className="text-foreground text-lg max-md:text-base leading-7">
