          ...
          <div className="block">
            <div className="block" aria-label="Accordion. Open links with Enter or Space, close with Escape, and navigate with Arrow Keys">
              <details className="flex relative flex-col" id={d.id}>
                <summary className="border-b border-solid border-b-color-011 flex min-h-11 pb-2.5 justify-between items-center gap-x-2.5 text-color-001 cursor-pointer 2xl:pb-5" aria-controls={d.ariacontrols} aria-expanded="false">
                  <span className="flex">
          ...
          <div className="block">
            <div className="block" aria-label="Accordion. Open links with Enter or Space, close with Escape, and navigate with Arrow Keys">
              <details className="flex relative flex-col" id={d.id2}>
                <summary className="border-b border-solid border-b-color-011 flex min-h-11 pb-2.5 justify-between items-center gap-x-2.5 text-color-001 cursor-pointer 2xl:pb-5" aria-controls={d.ariacontrols2} aria-expanded="false">
                  <span className="flex">
