export default function NotFound() {
  return (
    ...
    >
      ...
      <h1 className="text-background text-[3rem] font-semibold leading-none max-md:text-[1.75rem]">404</h1>
      ...
      <div className="flex gap-4 max-md:flex-col">
        <a
          href="/"
          className="rounded-[60px] bg-primary px-7 py-3 text-[1rem] font-semibold text-color-001"
        >
          Retour à l'accueil
        </a>
        <a
          href="/formations"
          className="rounded-[60px] border border-solid border-surface px-7 py-3 text-[1rem] font-semibold text-background"
        >
          Voir les formations
        </a>
      </div>
