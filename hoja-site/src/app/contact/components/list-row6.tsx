...
export default function ListRow6({ d, meta }: { d: ListRow6Data; meta: DittoNodeMetaMap }) {
  return (
    <li data-ditto-id={meta[0]?.anchor} className="flex relative mx-3 justify-start items-center [word-break:break-word]">
      <a data-ditto-id={meta[1]?.anchor} className="flex justify-start items-center text-color-001 text-[0.8125rem] leading-[1.1875rem] tracking-[0.9px] uppercase cursor-pointer" data-component="link" href={d.href}>
        {" "}
